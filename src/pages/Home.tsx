...
import { ArrowRight, CheckCircle, Clock, Shield, Star, Wrench, Users, Calendar, X, AlertTriangle, Zap, DollarSign, Settings, Truck } from 'lucide-react';
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Conocemos los obstáculos de la construcción y tenemos la respuesta perfecta
              </p>
            </div>
            
            <BentoGrid className="max-w-6xl mx-auto">
              {problems.map((item, index) => (
                <BentoItem key={index} className="bg-white border border-gray-200 hover:border-gray-300 hover:shadow-xl transition-all duration-300 group">
                  <div className="space-y-6">
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        {item.problemIcon}
                        <span className="font-semibold text-red-600 text-sm uppercase tracking-wide">Problema</span>
                      </div>
                    ...
                    <div className="border-t border-gray-100 pt-4 space-y-3">
                      <div className="flex items-center gap-3">
                        {item.solutionIcon}
                        <span className="font-semibold text-green-600 text-sm uppercase tracking-wide">Solución DMAC</span>
                      </div>
                      <p className="text-gray-900 font-medium leading-relaxed">{item.solution}</p>
                    </div>
                  </div>
                </BentoItem>
              ))}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              {tools.map((tool, index) => (
                <div key={index} className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-gray-200 group">
                  ...
                  <p className="text-yellow-600 font-bold text-lg">${tool.price.toLocaleString('es-CL')} / día</p>
                </div>
              ))}
            </div>
